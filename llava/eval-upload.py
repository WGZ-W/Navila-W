...
def get_action(model, image_list, text, norm_stats, action_tokenizer, same_seq=False):
...
def main():
    ...
    eval_info = "YOUR_EVALUATION_INFO_PATH_HERE"
    ...
    dataset_statistics_path = "YOUR_DATASET_STATISTICS_PATH_HERE"
        ...
        for idx, item in enumerate(eval_info):
            ...
            while step < MAX_STEP:
                try:
                    ...
                    model_action = get_action(model, image_list, text, norm_stats, action_tokenizer, same_seq)
