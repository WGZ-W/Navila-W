...
COYO_25M_VILA = "~/dataset/captioning/coyo-25m-vila"
...
def prepare_wids_meta(data_path, cache_dir="~/dataset/vila-webds-meta-2", idx=0, total=0):
...
class VILAWebDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        meta_path=None,
        cache_dir="/home/ligengz/dataset/vila-webds-meta",
