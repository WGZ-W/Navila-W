...
# _C.TASK.RXR_INSTRUCTION_SENSOR.features_path = "data/dataset/RxR_VLNCE_v0/text_features/rxr_{split}/{id:06}_{lang}_text_features.npz"
...
_C.TASK.NDTW.GT_PATH = "data/dataset/R2R_VLNCE_v1-3_preprocessed/{split}/{split}_gt.json.gz"
