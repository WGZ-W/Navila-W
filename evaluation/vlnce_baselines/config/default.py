...
_C.IL.RECOLLECT_TRAINER.gt_file = "data/dataset/RxR_VLNCE_v0/{split}/{split}_{role}_gt.json.gz"
...
_C.MODEL.INSTRUCTION_ENCODER.embedding_file = "data/dataset/R2R_VLNCE_v1-3_preprocessed/embeddings.json.gz"
_C.MODEL.INSTRUCTION_ENCODER.dataset_vocab = "data/dataset/R2R_VLNCE_v1-3_preprocessed/train/train.json.gz"
